...
# We will refactor module "deal_card" and name it "_deal_card"
# How to refactor ==> Right click > Refactor > Rename
# See section named "Import_test 1: Refactor" in "Import_test.py"



def _deal_card(frame):  # takes parameter "frame" which is the frame that the card will be displayed on.
...
def initial_deal():
    deal_player()  # one card for player
    dealer_hand.append(_deal_card(dealer_card_frame))  # one card for dealer
    dealer_score_label.set(score_hand(dealer_hand))   # Displays the Card value of dealer in screen
    deal_player()  # one card for player
...
# ================================================
# Modifying variables that start and end with __
# ================================================

# This will be used by "Import_test 2: renaming __name__ " in "Import_test.py" module
# NOTE: we should not be doing this, and this is just for demonstration
# We will comment this out after testin
